...
export class TabelaMyPokemons1628257220882 implements MigrationInterface {
    name = 'TabelaMyPokemons1628257220882'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "mypokemons" ("id" SERIAL NOT NULL, "userId" integer, "pokemonId" integer, CONSTRAINT "PK_c4d9f0c6018ec29102a85384953" PRIMARY KEY ("id"))`);
